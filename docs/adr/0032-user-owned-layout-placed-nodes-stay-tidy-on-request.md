...
- The `canvas-layout` skill teaches Claude this contract: stable ids, new content given an edge to its subject, a check after each render, and when to run or offer a tidy (#30).
